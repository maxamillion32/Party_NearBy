...
public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof PubsDataViewHolder) {
            ...
            if(name != null && !name.isEmpty()) {
                ((PubsDataViewHolder) holder).name.setText(Singleton.capitalize(name));
            }

            if(desc != null && !desc.isEmpty()) {
                ((PubsDataViewHolder) holder).desc.setText(Singleton.capitalize(desc));
            }

            if(ratCount != null && !ratCount.isEmpty()) {
                float rat = Float.valueOf(ratCount);
                ((PubsDataViewHolder) holder).rating_bar.setRating(rat);
            }
