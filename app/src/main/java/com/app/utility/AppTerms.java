...
public class AppTerms {
    ...
    public AppTerms(Activity context, String text, String title) {
        mContext = context;
        mText = text;
        mTitle = title;
    }
...
// the AndroidManifest.xml
        ...
        final String eulaKey = EULA_PREFIX + versionInfo.versionCode;
            ...
            // EULA title
            String title = mTitle + " v "+ versionInfo.versionName; //mContext.getString(R.string.app_name) + " v "+ versionInfo.versionName;

            // EULA text
            String message = mText;//mContext.getString(R.string.eula_string);
